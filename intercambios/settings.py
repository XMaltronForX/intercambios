...
SECRET_KEY = 'django-insecure-y2zx=%#7u7zq_odm*8@2_5d_n5$li48-3@y-@+y)90%yjzr#ey'
...
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'  # Verifica el correo antes de permitir el acceso
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'eliasrgatica@gmail.com' 
EMAIL_HOST_PASSWORD = 'odwd rshx aonj kuvb'
